...
- (void) updateAppearance
{
    ...
    self.opaque = NO;
    self.backgroundColor = [UIColor colorWithRed:123/255.0 green:188/255.0 blue:62/255.0 alpha:self.backgroundAlpha];
...
{
    if (!_countdownColor) {
        _countdownColor = [UIColor colorWithHexString:@"#7bbc3e"];
    }
